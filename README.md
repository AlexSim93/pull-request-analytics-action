...
| Parameter Name            | Description                                                                                                                                                                                                                                                                                              | Required | Default Value                                            | Example                                                  |
| ------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- | -------------------------------------------------------- | -------------------------------------------------------- |
| `GITHUB_TOKEN`            | `GITHUB_TOKEN` or personal access token. **repo** and **read:org** scopes required for **personal access token(classic)**. For scenarios involving data collection from multiple repositories or handling a large number of pull requests, it's recommended to use a **personal access token (classic)** | Yes      | -                                                        | `${{ secrets.GITHUB_TOKEN }}`                            |
| `GITHUB_OWNER_FOR_ISSUE`  | Owner of the repository where an issue with the report needs to be created. This parameter is mandatory if `EXECUTION_OUTCOME` includes `new-issue` or `existing-issue` values.                                                                                                                          | No       | -                                                        | `AlexSim93`                                              |
| `GITHUB_REPO_FOR_ISSUE`   | The repository where an issue with the report needs to be created. This parameter is mandatory if `EXECUTION_OUTCOME` includes `new-issue` or `existing-issue` values.                                                                                                                                   | No       | -                                                        | `pull-request-analytics-action`                          |
| `GITHUB_OWNERS_REPOS`     | Owners and repositories in the format `owner/repository` separated by commas. Either `GITHUB_OWNERS_REPOS` or `ORGANIZATIONS` must be set.                                                                                                                                                               | No       | -                                                        | `AlexSim93/pull-request-analytics-action`                |
| `ORGANIZATIONS`           | GitHub organizations, separated by commas. Repositories from these organizations will be added to the `GITHUB_OWNERS_REPOS` list to create an array with unique repositories. Either `GITHUB_OWNERS_REPOS` or `ORGANIZATIONS` must be set.                                                               | No       | -                                                        | `your-organization`                                      |
| `SHOW_STATS_TYPES`        | Stats types that should be displayed in report. Values must be separated by commas. Can take values: `timeline`, `workload`, `pr-quality`, `code-review-engagement`                                                                                                                                      | No       | `timeline, workload, pr-quality, code-review-engagement` | `timeline, workload, pr-quality, code-review-engagement` |
| `AGGREGATE_VALUE_METHODS` | Aggregate value methods for timelines separated by commas. Can take values: `percentile`, `average`, `median`                                                                                                                                                                                            | No       | `percentile`                                             | `percentile, average, median`                            |
| `AMOUNT`                  | Number of pull requests in the report. Ignored if the `REPORT_DATE_START` is set                                                                                                                                                                                                                         | No       | `100`                                                    | `100`                                                    |
| `REVIEW_TIME_INTERVALS`   | Intervals for determining review times distribution                                                                                                                                                                                                                                                      | No       | -                                                        | `2, 5, 10`                                               |
| `APPROVAL_TIME_INTERVALS` | Intervals for determining approval times distribution                                                                                                                                                                                                                                                    | No       | -                                                        | `2, 5, 10`                                               |
| `MERGE_TIME_INTERVALS`    | Intervals for determining merge times distribution                                                                                                                                                                                                                                                       | No       | -                                                        | `2, 5, 10`                                               |
| `TOP_LIST_AMOUNT`         | Amount of items in lists                                                                                                                                                                                                                                                                                 | No       | `5`                                                      | `5`                                                      |
| `REPORT_DATE_START`       | Start date for the report (d/MM/yyyy)                                                                                                                                                                                                                                                                    | No       | -                                                        | `20/10/2023`                                             |
| `REPORT_DATE_END`         | End date for the report (d/MM/yyyy)                                                                                                                                                                                                                                                                      | No       | -                                                        | `30/10/2023`                                             |
| `REPORT_PERIOD`           | Report period from now. Values format `[unit]:value` separated by commas. Supported units: `years`, `months`, `weeks`, `days`, `hours`, `minutes`, `seconds`.                                                                                                                                            | No       | -                                                        | `weeks:2`                                                |
| `PERIOD_SPLIT_UNIT`       | Unit for time segmentation. Can take values: `years`, `quarters`, `months`, `none`                                                                                                                                                                                                                       | No       | `months`                                                 | `months`                                                 |
| `CORE_HOURS_START`        | Start of core hours (HH:mm). By default in UTC                                                                                                                                                                                                                                                           | No       | -                                                        | `10:00`                                                  |
| `CORE_HOURS_END`          | End of core hours (HH:mm). By default in UTC                                                                                                                                                                                                                                                             | No       | -                                                        | `19:00`                                                  |
| `HOLIDAYS`                | Holidays separated by comma (d/MM/yyyy)                                                                                                                                                                                                                                                                  | No       | -                                                        | `01/01/2024, 08/03/2024`                                 |
| `TIMEZONE`                | Timezone that will be used in action                                                                                                                                                                                                                                                                     | No       | `UTC`                                                    | `Europe/Berlin`                                          |
| `PERCENTILE`              | Percentile value for timeline                                                                                                                                                                                                                                                                            | No       | `75`                                                     | `75`                                                     |
| `ISSUE_TITLE`             | Title for the created issue                                                                                                                                                                                                                                                                              | No       | `Pull requests report(d/MM/yyyy HH:mm)`                  | `Report`                                                 |
| `LABELS`                  | Labels for the created issue separated by commas                                                                                                                                                                                                                                                         | No       | -                                                        | `Analytics`                                              |
| `ASSIGNEES`               | Assignees for the issue separated by commas                                                                                                                                                                                                                                                              | No       | -                                                        | `AlexSim93`                                              |
| `HIDE_USERS`              | Hides selected users from reports, while still including their data in the analytics. Use `total` to hide total stats. Users should be separated by commas.                                                                                                                                              | No       | -                                                        | `user-name-1, user-name-2`                               |
| `SHOW_USERS`              | Displays only specified users in reports, but includes all users in the background analytics. Use `total` to show total stats. Users should be separated by commas.                                                                                                                                      | No       | -                                                        | `user-name-3, user-name-4`                               |
| `EXCLUDE_LABELS`          | Excludes PRs with mentioned labels. Values should be separated by commas                                                                                                                                                                                                                                 | No       | -                                                        | `documentation`                                          |
| `INCLUDE_LABELS`          | Includes only PRs with mentioned labels. Values should be separated by commas                                                                                                                                                                                                                            | No       | -                                                        | `bugfix`                                                 |
| `EXECUTION_OUTCOME`       | Outcome format separated by commas. Can take values: `new-issue`, `markdown`, `collection`, `existing-issue`.                                                                                                                                                                                            | No       | `new-issue`                                              | `existing-issue`                                         |
| `ISSUE_NUMBER`            | Issue number to update. Add `existing-issue` to `EXECUTION_OUTCOME` for updating existing issue                                                                                                                                                                                                          | No       | -                                                        | `12`                                                     |
| `ALLOW_ANALYTICS`         | Allows sending non-sensitive inputs to mixpanel. Set the value to `false` to disable data transmission to Mixpanel                                                                                                                                                                                       | No       | `true`                                                   | `false`                                                  |
