...
![Version](https://img.shields.io/badge/version-2.2.1-blue) ![License](https://img.shields.io/badge/license-MIT-green)
...
| `SHOW_STATS_TYPES`        | Stats types that should be displayed in report. Values must be separated by commas. Can take values: `timeline`, `workload`, `pr-quality`, `code-review-engagement`. Example: `timeline, workload, pr-quality, code-review-engagement`                                                                                                                                                                | `timeline, workload, pr-quality, code-review-engagement` |
